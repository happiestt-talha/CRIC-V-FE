...
export default function SessionCard({ session, onDeleteSuccess }) {
    ...
    return (
        <>
            <Card className="bg-slate-900 border-slate-800 hover:border-slate-700 transition-colors relative group">
                {isCoachOrAdmin && (
                    <Button
                        variant="ghost"
                        size="icon"
                ...
                <CardContent className="p-5">
                    <div className="flex items-start gap-3 mb-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <h3 className="text-white font-semibold text-sm truncate pr-6">
