        ...
        return (
            <Card className="bg-slate-900 border-slate-800">
                <CardContent className="py-10 text-center">
                    <p className="text-slate-400 text-sm">No bowling data available</p>
                </CardContent>
            </Card>
        )
    }
    ...
    return (
        <div className="space-y-4">
            ...
            {metrics.release_point && (
                <Card className="bg-slate-900 border-slate-800">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-white text-sm">Release Point</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-3 gap-3">
                            {Object.entries(metrics.release_point).map(([axis, val]) => (
                                <div key={axis} className="text-center p-3 bg-slate-800 rounded-lg">
                                    <p className="text-green-400 font-bold text-sm">
                                        {Number(val).toFixed(2)}
                                    </p>
                                    <p className="text-slate-500 text-xs mt-1 uppercase">{axis}</p>
                                </div>
                            ))}
                        </div>
                    </CardContent>
            ...
            {metrics.front_foot_landing && (
                <Card className="bg-slate-900 border-slate-800">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-white text-sm">Front Foot Landing</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-3 gap-3">
