...
const MetricCard = ({ icon: Icon, label, value, unit, colorStatus = 'neutral' }) => {
  ...
  return (
    <Card className="bg-slate-800/40 border-slate-700/50 backdrop-blur-sm hover:bg-slate-800/60 transition-colors">
      <CardContent className="p-4 flex flex-col items-center justify-center text-center space-y-1">
        <div className="p-2 rounded-full bg-slate-900/50 mb-1 ring-1 ring-slate-700/50">
